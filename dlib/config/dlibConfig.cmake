...
set(dlib_INCLUDE_DIRS "${dlib_INSTALL_PATH}/include" "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.11.sdk/usr")
...
set(dlib_LIBRARIES ${dlib_LIBRARIES} "/opt/local/lib/libSM.dylib;/opt/local/lib/libICE.dylib;/opt/local/lib/libX11.dylib;/opt/local/lib/libXext.dylib;/opt/local/lib/libpng.dylib;/usr/lib/libcblas.dylib;/usr/lib/liblapack.dylib;/usr/lib/libsqlite3.dylib")
set(dlib_LIBS      ${dlib_LIBRARIES} "/opt/local/lib/libSM.dylib;/opt/local/lib/libICE.dylib;/opt/local/lib/libX11.dylib;/opt/local/lib/libXext.dylib;/opt/local/lib/libpng.dylib;/usr/lib/libcblas.dylib;/usr/lib/liblapack.dylib;/usr/lib/libsqlite3.dylib")
